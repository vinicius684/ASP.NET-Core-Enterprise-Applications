...
namespace NSE.Pagamentos.API.Services
{
    ...
    {
        private readonly IMessageBus _bus;//escutar a fila
        private readonly IServiceProvider _serviceProvider;//gerar uma instancia dentro do meio singleton que ele trabalha
