...
{
    public class IdentityMensagensPortugues : IdentityErrorDescriber //coleção das mensagens de IdentityError. Onde dou um override em cada uma delas e retorno uma nova instancia de IdentityError com mensagens em portugues
    {
