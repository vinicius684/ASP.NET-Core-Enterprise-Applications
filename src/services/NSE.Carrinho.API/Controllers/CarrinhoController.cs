...
namespace NSE.Carrinho.API.Controllers
{
    ...
    public class CarrinhoController : MainController
    {
        ...
        {
            return await ObterCarrinhoCliente() ?? new CarrinhoCliente(); //caso o carrinho retornado seja nulo, retorna um instancia de carrinho
        }
        ...
        {
            var carrinho = await ObterCarrinhoCliente();
            var itemCarrinho = await ObterItemCarrinhoValidado(produtoId, carrinho, item); //obtem item do carrinho de acordo com o produtoId
        ...
        private void ManipularNovoCarrinho(CarrinhoItem item)
        {
            ...
            /*
              ...
              vai dar implicitamente um CarrinhoItem.Add(item), pois esse dado não vem do banco e sim é Criada 
              uma nova entidade. Logo o EF sabe que precisa criar o carrinho e depois criar os itens 
              associados a ele, por conta do mapeamento que foi feito
            */
        }
        private void ManipularCarrinhoExistente(CarrinhoCliente carrinho, CarrinhoItem item)
        {
            ...
            {
                _context.CarrinhoItens.Update(carrinho.ObterPorProdutoId(item.ProdutoId)); //atualizar item com a qtd somada
            }
            else
            {
                _context.CarrinhoItens.Add(item); //adicionar item
            }
