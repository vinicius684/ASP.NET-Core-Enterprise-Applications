...
namespace NSE.Pedidos.API.Application.Queries
{
    ...
    public class VoucherQueries : IVoucherQueries
    {
        ...
        public async Task<VoucherDTO> ObterVoucherPorCodigo(string codigo)
        {
            ...
            if (!voucher.EstaValidoParaUtilizacao()) return null; //não vai retornar os erros. Nesse momento eles não me interessam, apenas lá na Controller vou dizer que o vouhcer não está disponível
