...
namespace NSE.Pedidos.API.Application.DTO
{
    public class PedidoDTO
    {
        ...
        public static PedidoDTO ParaPedidoDTO(Pedido pedido) //as vezes é melhor contruir um método desse do que ficar colocando complexidade de automapper pra mapear apenas uma entidade
        {
